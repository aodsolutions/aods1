...
<meta name="msvalidate.01" content="583A0D79898C20C94E29321E9C42544A" />
     ...
     <!--   <section class="row" id="tmHome">
          <div class="col-12 tm-home-container">
            <div class="text-white tm-home-left">
              ...
              <hr class="tm-home-hr" />
              <h2 class="tm-home-title">Multi-Purpose App for Your Business</h2>
...
-->
        ...
        <div class="row" id="tmFeatures">
          <div class="col-lg-4">
            ...
            <h3 class="tm-feature-name">Database</h3>
            
            <div class="tm-feature-icon-container">
                <i class="fas fa-3x fa-server"></i>
            </div>

            <p class="text-center">MySQL Database Service is a fully managed database service to deploy cloud-native applications.</p>
            </div>
          </div>
...
<span class="sr-only"></span>
                  <!--  <i class="fas fa-3x fa-browser"></i>-->
                </div>
                <p class="text-center">SDLC - Software Development Life Cycle.
                </p>
            </div>
          </div>
          ...
          <div class="col-lg-4">
            <div class="tm-bg-white-transparent tm-feature-box">
                <h3 class="tm-feature-name">SEO</h3>

                <div class="tm-feature-icon-container">
                    <i class="fas fa-3x fa-satellite-dish"></i>
                </div>
                <p class="text-center">Search Engine Optimization.
                </p>
            </div>
          </div>
        </div>
        ...
        <div class="row" id="tmFeatures">
          <div class="col-lg-4">
            <div class="tm-bg-white-transparent tm-feature-box">
            <h3 class="tm-feature-name">App Development</h3>
            
            <div class="tm-feature-icon-container">
                <i class="fas fa-3x fa-code"></i>
            </div>

            <p class="text-center">We develop custom software 
              applications for web, desktop and mobile platforms.</p>
            </div>
          </div>

          <div class="col-lg-4">
            <div class="tm-bg-white-transparent tm-feature-box">
                <h3 class="tm-feature-name">Graphic Design</h3>

                <div class="tm-feature-icon-container">
                 <!-- <i class="fa fa-cog fa-spin fa-3x fa-fw" aria-hidden="true"></i>
<span class="sr-only"></span>
<i class="fas fa-3x fa-sticky-note-o"></i>
-->
                    
                    <i class="fa-sticky-note-o" aria-hidden="true"></i>
                </div>
                <p class="text-center">Visual representations to enhance or 
                  enable the representation of an idea.
          ...
          <div class="col-lg-4">
            <div class="tm-bg-white-transparent tm-feature-box">
                <h3 class="tm-feature-name">Networking</h3>

                <div class="tm-feature-icon-container">
                    <i class="fas fa-3x fa-satellite-dish"></i>
                </div>
                <p class="text-center">Network solutions.
                </p>
            </div>
          </div>
...
<li class="wp-social-link wp-social-link-instagram wp-block-social-link"><a href="https://www.instagram.com/aodevsolutions/" aria-label="Instagram AODS " 
...
<li class="wp-social-link wp-social-link-linkedin wp-block-social-link"><a href="https://www.linkedin.com/company/aodevsolutions" aria-label="LinkedIn"  
...
<li class="wp-social-link wp-social-link-facebook wp-block-social-link"><a href="https://www.facebook.com/aodevsolutions" aria-label="Facebook AODS "  
